...
describe("ContextualHelp", () => {
    ...
    it("should support custom class", () => {
        render(
            <ContextualHelp data-testid="ContextualHelp" className="test">
                12
            </ContextualHelp>
        );
    ...
    it("should support custom style", () => {
        render(
            <ContextualHelp data-testid="ContextualHelp" marginTop="stack-sm" style={{ marginBottom: "13px" }}>
                12
            </ContextualHelp>
        );
    ...
    it("should support DOM props", () => {
        render(
            <ContextualHelp data-testid="ContextualHelp" data-foo="bar">
                12
            </ContextualHelp>
        );
    ...
    it("should support slots", () => {
        render(
            <ContextualHelpContext.Provider value={{ slots: { test: { "aria-label": "test" } } }}>
                <ContextualHelp data-testid="ContextualHelp" slot="test">
                    12
                </ContextualHelp>
    ...
    it("should support refs", () => {
        ...
        render(
            <ContextualHelp data-testid="ContextualHelp" ref={ref}>
                12
            </ContextualHelp>
        );
