...
<TokenTable tokenType="components" category="color" data={[{
...
<DosAndDonts
    items={[
        {
            do: {
                explanation: "Reference the value from the 'Component Prop Value' column in the tokens table when setting component properties.",
