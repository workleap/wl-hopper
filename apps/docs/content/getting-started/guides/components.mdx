...
<SimpleTable
    ...
    data={[
        { "Customization Tier": "🥇 Gold Tier", "Description": "Maximize reuse of the Design System, applying only minimal overwrites to fit your needs." },
        { "Customization Tier": "🥈 Silver Tier", "Description": "Reuse most of the component's behaviors, but make some modifications to fit your needs." },
        { "Customization Tier": "🥉 Bronze Tier", "Description": "Reassemble the component's behavior using smaller utility methods." },
        { "Customization Tier": "🛠️ Do it yourself", "Description": "Build the behavior from scratch and use low-level styling tools as needed." }
    ]}
/>
