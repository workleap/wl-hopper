...
describe("ComboBox", () => {
    it("should render with default class", () => {
        render(
            <ComboBox aria-label="Roles" data-testid="ComboBox">
    ...
    it("should support custom class", () => {
        render(
            <ComboBox aria-label="Roles" className="test" data-testid="ComboBox">
                <ComboBoxItem>Item 1</ComboBoxItem>
                <ComboBoxItem>Item 2</ComboBoxItem>
                <ComboBoxItem>Item 3</ComboBoxItem>
            </ComboBox>
    ...
    it("should support custom style", () => {
        render(
            <ComboBox aria-label="Roles" marginTop="stack-sm" style={{ marginBottom: "13px" }} data-testid="ComboBox">
                <ComboBoxItem>Item 1</ComboBoxItem>
                <ComboBoxItem>Item 2</ComboBoxItem>
                <ComboBoxItem>Item 3</ComboBoxItem>
            </ComboBox>
    ...
    it("should support DOM props", () => {
        render(
            <ComboBox aria-label="Roles" data-foo="bar" data-testid="ComboBox">
                <ComboBoxItem>Item 1</ComboBoxItem>
                <ComboBoxItem>Item 2</ComboBoxItem>
                <ComboBoxItem>Item 3</ComboBoxItem>
            </ComboBox>
    ...
    it("should support refs", () => {
        ...
        render(
            <ComboBox ref={ref} aria-label="Roles">
                <ComboBoxItem>Item 1</ComboBoxItem>
                <ComboBoxItem>Item 2</ComboBoxItem>
                <ComboBoxItem>Item 3</ComboBoxItem>
            </ComboBox>
