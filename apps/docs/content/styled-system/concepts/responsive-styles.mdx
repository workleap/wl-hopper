...
<Example src="hopper-provider/docs/responsive-styles/introduction" isOpen />
...
<Example src="hopper-provider/docs/responsive-styles/mobile-first-do-not" isOpen />

<Callout variant="success">Use `base` to target mobile devices</Callout>

<Example src="hopper-provider/docs/responsive-styles/mobile-first-do" isOpen />
...
<Example src="hopper-provider/docs/responsive-styles/useResponsiveValue" isOpen />
