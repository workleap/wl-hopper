...
- **`validate_hopper_code`**: Validates Hopper component implementation including design tokens, prop values, UNSAFE\_ usage, component structure, and layout patterns. Returns errors and warnings. Use after implementing or changing Hopper components.
