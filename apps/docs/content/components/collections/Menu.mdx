...
<Menu>
    ...
    <MenuSection>
        {" "}
        /* (Optional) A section in the Menu */
...
<ComposedComponents components={["Header", "Divider", "Avatar", "Text", "Icon", "IconList"]} />
...
A menu item can have end icons.
