...
export type UseDebounceResult<TState> = [TState, Dispatch<SetStateAction<TState>>, Dispatch<SetStateAction<TState>>];

export function useDebounce<TState>(
    initialState: TState | (() => TState),
    wait?: SuggestedDebouncedWaitTimes,
    leading?: boolean
): UseDebounceResult<TState> {
