...
<TableSection tokenType={"semantic"} categoryKey="size" tokens={tokens.semantic.paddingSize} categories={
    ["inset"]
...
<TableSection tokenType={"semantic"} categoryKey="size" tokens={tokens.semantic.marginSize} categories={
    ["stack"]
} />
