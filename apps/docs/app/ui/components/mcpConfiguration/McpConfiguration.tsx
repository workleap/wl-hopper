        ...
        assistants.map(async assistant => {
            ...
            return (
                <div key={assistant}>
                    ...
                    {assistant === "vscode" && (
                        <p className="hd-mcp-config__note">
                            Create or update <code className="hd-code">.vscode/mcp.json</code> in the root of your
                            project:
                        </p>
                    )}
    ...
    return (
        <>
            ...
            <Callout variant="information">
                <span>
                    <strong>Chrome DevTools MCP</strong> (optional but recommended): Enables visual comparison between
                    your generated code and the original Figma design for better results.
                </span>
            </Callout>
        </>
    );
