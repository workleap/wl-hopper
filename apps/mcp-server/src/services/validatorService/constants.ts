...
export const LAYOUT_COMPONENTS = new Set(["Stack", "Inline", "Flex", "Grid", "Div", "Box"]);

// Props that accept percentage values without requiring UNSAFE_ prefix
export const PERCENTAGE_SAFE_PROPS = new Set(["width", "height", "maxWidth", "minWidth", "maxHeight", "minHeight"]);
