...
describe("Callout", () => {
    ...
    it("should support custom class", () => {
        render(
            <Callout data-testid="Callout" className="test">
                12
            </Callout>
        );
    ...
    it("should support custom style", () => {
        render(
            <Callout data-testid="Callout" marginTop="stack-sm" style={{ marginBottom: "13px" }}>
                12
            </Callout>
        );
    ...
    it("should support DOM props", () => {
        render(
            <Callout data-testid="Callout" data-foo="bar">
                12
            </Callout>
        );
    ...
    it("should support slots", () => {
        render(
            <CalloutContext.Provider value={{ slots: { test: { "aria-label": "test" } } }}>
                <Callout data-testid="Callout" slot="test">
                    12
                </Callout>
    ...
    it("should support refs", () => {
        ...
        render(
            <Callout data-testid="Callout" ref={ref}>
                12
            </Callout>
        );
