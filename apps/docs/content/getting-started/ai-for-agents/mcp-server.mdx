...
- **`get_component_documentation`**: Retrieve comprehensive component documentation including anatomy, structure, examples, dos and don'ts, and best practices
- **`get_component_props`**: Get detailed component API as JSON, including properties, attributes, methods, and events

### Guide Tools

- **`get_guide`**: Access comprehensive guides and best practices covering:
