...
<DosAndDonts
    items={[
        ...
        },
        {
            ...
            dont: {
                explanation: "Use punctuation marks such as periods or exclamation points.",
                example: <Example type="preview" src="buttons/docs/button/dos-and-donts/punctuation-dont" hideStackblitzButton />
            }
        },
        {
            do: {
                explanation: "Use links when the desired action is to take the user to a new page."
            },
            dont: {
                explanation: "Use buttons as navigational elements."
            }
        }
    ]}
/>
