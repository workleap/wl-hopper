...
<DoDont>
    <DoDont.Item>
        <Do>Use `setColorScheme` hook to set the application color scheme.</Do>
        <Dont>Never Set Hopper token directly on the `document.body` to set light or dark modes.</Dont>
    </DoDont.Item>
</DoDont>
