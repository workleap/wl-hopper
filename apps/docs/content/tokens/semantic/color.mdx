...
### Neutral
<TableSection tokenType={"semantic"} categoryKey="color" tokens={tokens.semantic.color} categories={
    ["hop-neutral"]
} />
...
### Neutral
<TableSection tokenType={"semantic"} categoryKey="color" tokens={tokensDark.semantic.color} categories={
    ["hop-neutral"]
} />
