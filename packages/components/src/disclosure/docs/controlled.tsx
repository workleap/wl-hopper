...
export default function Example() {
    ...
    return (
        <Disclosure width="100%" isExpanded={isExpanded} onExpandedChange={setIsExpanded}>
            <DisclosureHeader>This disclosure is {isExpanded ? "expanded" : "collapsed"}</DisclosureHeader>
            <DisclosurePanel>
