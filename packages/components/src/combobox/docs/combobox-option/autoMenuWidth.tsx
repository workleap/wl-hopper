...
export default function Example() {
    return (
        <ComboBox aria-label="list of options with a description" isAutoMenuWidth label="Roles">
            ...
            <ComboBoxItem textValue="Manager">
                ...
                <Text slot="description">
                    Responsible for leading and overseeing a team or department to ensure organizational goals are met.
                </Text>
            </ComboBoxItem>
        </ComboBox>
    );
