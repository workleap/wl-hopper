...
A select can include a search input to filter items in the dropdown. This is useful for long lists where users need to quickly find specific options, to enable this use the `isFilterable` prop.
