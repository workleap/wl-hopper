...
<PropsReferenceTable
    rows={[
        ["margin", "margin", "spacing-margin-scale", "breakpoints"],
        ["marginTop", "margin-top", "spacing-margin-scale", "breakpoints"],
        ["marginBottom", "margin-bottom", "spacing-margin-scale", "breakpoints"],
        ["marginRight", "margin-right", "spacing-margin-scale", "breakpoints"],
        ["marginLeft", "margin-left", "spacing-margin-scale", "breakpoints"],
        ["marginX", "margin-left & margin-right", "spacing-margin-scale", "breakpoints"],
        ["marginY", "margin-top & margin-bottom", "spacing-margin-scale", "breakpoints"],
        ["padding", "padding", "spacing-padding-scale", "breakpoints"],
        ["paddingTop", "padding-top", "spacing-padding-scale", "breakpoints"],
        ["paddingBottom", "padding-bottom", "spacing-padding-scale", "breakpoints"],
        ["paddingRight", "padding-right", "spacing-padding-scale", "breakpoints"],
        ["paddingLeft", "padding-left", "spacing-padding-scale", "breakpoints"],
        ["paddingX", "padding-left & padding-right", "spacing-padding-scale", "breakpoints"],
        ["paddingY", "padding-top & padding-bottom", "spacing-padding-scale", "breakpoints"],
...
<PropsReferenceTable
    rows={[
        ...
        ["gap", "gap", "spacing-margin-scale", "breakpoints"],
...
<PropsReferenceTable
    rows={[
        ...
        ["columnGap", "column-gap", "spacing-margin-scale", "breakpoints"],
        ["rowGap", "row-gap", "spacing-margin-scale", "breakpoints"],
    ]}
/>
