...
<Figure
    src="https://cdn.platform.workleap.com/hopper/webdoc/token-details.png"
    width="654"
    height="45"
    alt="Token tiers diagram"
    caption="A three tier token system allows a separation of concerns regarding design decisions."
/>
...
<TokenTable
    ...
    data={[
        {
            name: "hop-comp-button-primary-disabled",
            value: "#95b1ff"
        }
    ]}
/>
    ...
    items={[
        {
            do: {
                ...
                example: <code>{'<Div backgroundColor="neutral" />'}</code>
            },
            dont: {
                explanation: "Use the 'Token Name (CSS Variable Name)' directly in the component prop value.",
                example: <code>{'<Div backgroundColor="neutral-surface" />'}</code>
            }
        }
    ]}
/>
