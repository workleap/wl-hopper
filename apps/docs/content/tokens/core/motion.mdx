...
<TokenTable category={"duration"} data={(tokens) => tokens.core["duration"]} noPreview />
...
<TokenTable category={"timingFunction"} data={(tokens) => tokens.core["timingFunction"]} noPreview />

### Playground

<MotionPreview noPreview />
