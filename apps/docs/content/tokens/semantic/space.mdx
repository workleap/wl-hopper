...
<TableSection tokenType={"semantic"} categoryKey="size" tokens={tokens => tokens.semantic.paddingSize} categories={
    ["inset"]
...
<TableSection tokenType={"semantic"} categoryKey="size" tokens={tokens => tokens.semantic.marginSize} categories={
    ["stack"]
} />
