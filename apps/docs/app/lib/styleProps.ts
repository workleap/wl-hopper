...
export const TokenCategories = [
    ...
    "semantic-lineHeight",
    "semantic-topOffset",
    "semantic-bottomOffset",
    "semantic-borderRadius",
    "semantic-paddingSize",
    "semantic-marginSize",
    "core-color",
    "core-shadow",
    "core-fontFamily",
...
export const stylePropDefinitions: StylePropDefinition[] = [
    // Space
    {
        propName: "margin",
        cssProperty: "margin",
        tokenScale: "spacing-margin-scale",
        supportedFeatures: "breakpoints",
        group: "Space"
    },
    {
        propName: "marginTop",
    ...
    },
    {
        propName: "padding",
        cssProperty: "padding",
        tokenScale: "spacing-padding-scale",
        supportedFeatures: "breakpoints",
        group: "Space"
    },
    {
    ...
    // Color
    {
        propName: "color",
        cssProperty: "color",
        tokenScale: "color-scale",
        supportedFeatures: "breakpoints & focus/hover/active",
        group: "Color"
    },
    {
    ...
    },
    {
        ...
        cssProperty: "fill",
        tokenScale: "color-scale",
        supportedFeatures: "breakpoints & focus/hover",
        group: "Color"
    },
    {
        propName: "stroke",
    ...
    // Typography
    {
        ...
        tokenScale: "typography-fontFamily-scale",
        supportedFeatures: "breakpoints",
        group: "Typography"
    },
    {
        ...
        tokenScale: "typography-fontSize-scale",
        supportedFeatures: "breakpoints",
        group: "Typography"
    },
    {
        ...
        tokenScale: "typography-fontWeight-scale",
        supportedFeatures: "breakpoints",
        group: "Typography"
    },
    {
        ...
        tokenScale: "typography-lineHeight-scale",
        supportedFeatures: "breakpoints",
        group: "Typography"
    },
    {
        ...
        tokenScale: "typography-letterSpacing-scale",
        supportedFeatures: "breakpoints",
        group: "Typography"
    },
    {
    ...
    {
        propName: "gridColumnSpan",
        cssProperty: "grid-column-span",
        tokenScale: "none",
        supportedFeatures: "breakpoints",
        group: "Grid Layout"
    },
    ...
    {
        propName: "gridRowSpan",
        cssProperty: "grid-row-span",
        tokenScale: "none",
        supportedFeatures: "breakpoints",
        group: "Grid Layout"
    },
    ...
    },
    {
        ...
        cssProperty: "outline",
        tokenScale: "color-scale",
        supportedFeatures: "breakpoints & focus",
        group: "Border"
    },
    ...
    },
    {
        ...
        cssProperty: "cursor",
        tokenScale: "none",
        supportedFeatures: "breakpoint & hover",
        group: "Miscellaneous"
    },
    {
...
export function getPropsTableRows(category?: StyleGroup): PropsTableRow[] {
    ...
    return filteredProps.map(prop => [prop.propName, prop.cssProperty, prop.tokenScale, prop.supportedFeatures]);
}
...
export function getPropsGroupedByCategory(): Record<StyleGroup, StylePropDefinition[]> {
    return stylePropDefinitions.reduce(
        (grouped, prop) => {
