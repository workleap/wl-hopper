...
<TableSection tokenType={"semantic"} categoryKey="size" tokens={tokens.semantic.sizePadding} categories={
    ["inset"]
...
<TableSection tokenType={"semantic"} categoryKey="size" tokens={tokens.semantic.sizeMargin} categories={
    ["stack"]
} />
