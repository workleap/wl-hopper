...
describe("Header", () => {
    ...
    it("should support custom class", () => {
        render(
            <Header data-testid="header" className="test">
                Test
            </Header>
        );
    ...
    it("should support custom style", () => {
        render(
            <Header data-testid="header" marginTop="stack-sm" style={{ marginBottom: "13px" }}>
                Test
            </Header>
        );
    ...
    it("should support DOM props", () => {
        render(
            <Header data-testid="header" data-foo="bar">
                Test
            </Header>
        );
    ...
    it("should support slots", () => {
        render(
            <HeaderContext.Provider value={{ slots: { test: { "aria-label": "test" } } }}>
                <Header data-testid="header" slot="test">
                    Test
                </Header>
    ...
    it("should support refs", () => {
        ...
        render(
            <Header data-testid="header" ref={ref}>
                Test
            </Header>
        );
