...
<Example src="hopper-provider/docs/color-scheme/apply" isOpen />
...
<Example src="hopper-provider/docs/color-scheme/apply-system" isOpen />
...
<Example src="hopper-provider/docs/color-scheme/apply-nested" isOpen />

## Context Hooks

To manage the color scheme in your application, Hopper exposes a `ColorSchemeContext` and a `useColorSchemeContext` hook.

<Example src="hopper-provider/docs/color-scheme/changing" isOpen />
...
<Example src="hopper-provider/docs/color-scheme/useColorSchemeValue" isOpen />
...
<DosAndDonts
    items={[
        {
            do: {
                explanation: "Use the setColorScheme from useColorSchemeContext hook to programmatically change the application's color scheme"
            },
            dont: {
                explanation: "Manually set Hopper tokens directly on document.body to control light or dark mode"
            }
        }
    ]}
/>
