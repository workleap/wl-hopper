...
export const SingleSelection = {
    render: props => {
        return (
            <Stack>
                <TagGroup {...props} size="sm" label="Small" selectionMode="single" defaultSelectedKeys={["designer"]}>
                    <Tag id="developer" textValue="Developer">
                        <SparklesIcon />
                        <Text>Developer</Text>
                    </Tag>
                    <Tag id="designer" textValue="Designer">
                        <SparklesIcon />
                        <Text>Designer</Text>
                    </Tag>
                    <Tag id="manager" textValue="Manager">
                        <SparklesIcon />
                        <Text>Manager</Text>
                    </Tag>
                </TagGroup>
                <TagGroup {...props} size="md" label="Medium" selectionMode="single" defaultSelectedKeys={["designer"]}>
                    <Tag id="developer" textValue="Developer">
                        <SparklesIcon />
                        <Text>Developer</Text>
                    </Tag>
                ...
                <TagGroup {...props} size="lg" label="Large" selectionMode="single" defaultSelectedKeys={["designer"]}>
                    <Tag id="developer" textValue="Developer">
                        <SparklesIcon />
                        <Text>Developer</Text>
                    </Tag>
