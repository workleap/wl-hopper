...
### Neutral
<TableSection tokenType={"semantic"} categoryKey="color" tokens={tokens => tokens.semantic.color} categories={
    ["hop-neutral"]
} />
...
### Neutral
<TableSection tokenType={"semantic"} categoryKey="color" colorScheme="dark" tokens={tokens => tokens.semantic.color} categories={
    ["hop-neutral"]
} />
