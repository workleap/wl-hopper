...
- **The emitted JavaScript is no longer downleveled to ES2019.** It now ships the modern syntax the source is written in. The ES2019 target existed for a Storybook 6 constraint that no longer applies.
