...
<Figure
    src="/product-cycle.png"
    width="679"
    height="567"
    alt="Diagram illustrating the four pace layers of the digital product process"
    caption="In the pace layers of digital products, product zips along at the outer layer while design systems and other supporting infrastructure move more slowly at the inner layer."
    priority
/>
...
<SimpleTable
    aria-label="Customization Tiers"
    headers={["Customization Tier", "Description"]}
    data={[
        {
            "Customization Tier": "🥇 Gold Tier",
            Description: "Maximize reuse of the Design System, applying only minimal overwrites to fit your needs."
        },
        {
            "Customization Tier": "🥈 Silver Tier",
            Description: "Reuse most of the component's behaviors, but make some modifications to fit your needs."
        },
        {
            "Customization Tier": "🥉 Bronze Tier",
            Description: "Reassemble the component's behavior using smaller utility methods."
        },
        {
            "Customization Tier": "🛠️ Do it yourself",
            Description: "Build the behavior from scratch and use low-level styling tools as needed."
        }
    ]}
/>
...
```tsx
<Button backgroundColor="primary" UNSAFE_width="148px" paddingTop="stack-xs">
    Click me
</Button>
```
...
<Callout variant="information">
    **Encountering Design System Limitations?**
    <br />
    <br /> If you need to copy a component due to a design system constraints, let us know! Frequent requests may lead
    to updates, allowing you to replace your custom component with an official version in the future.
    <br />
    <br /> Share your needs in **#ds-hopper!**
</Callout>
...
<Callout variant="warning">
    Using this approach may require you to restyle the entire component, which is fine. At this stage, you're
    essentially creating something new! Just be sure to use [Hopper tokens](../../tokens/overview/introduction) to
    ensure that any future branding updates are automatically applied to your component without needing manual
    adjustments. If you want to allow customization on your component, you can also use the `useStyledSystem` hook to
    expose style props!
</Callout>
