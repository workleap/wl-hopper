    ...
    items={[
        ...
        },
        {
            do: {
                ...
                example: <Example src="buttons/docs/button/dos-and-donts/punctuation-do" hideStackblitzButton />
            },
            dont: {
                explanation: "Don’t use punctuation marks such as periods or exclamation points.",
                example: <Example src="buttons/docs/button/dos-and-donts/punctuation-dont" hideStackblitzButton />
            }
        }
    ]}
/>
